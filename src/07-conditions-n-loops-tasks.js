 ...
 *
 * @example:
 *   { top: 0, left: 0, width: 10, height: 10 },5
...
function doRectanglesOverlap(rect1, rect2) {
  if (rect2.top < rect1.top + rect1.height && rect2.top > rect1.top
    && rect2.left < rect1.left + rect1.width && rect2.left > rect1.left) {
    return true;
  }
  if (rect2.top + rect2.height < rect1.top + rect1.height
  ...
  if (rect1.top < rect2.top + rect2.height && rect1.top > rect2.top
    && rect1.left < rect2.left + rect2.width && rect1.left > rect2.left) {
    return true;
  }
  ...
  if (rect1.top === rect2.top && rect2.left === rect1.left) {
    return true;
  }
  return false;
}
